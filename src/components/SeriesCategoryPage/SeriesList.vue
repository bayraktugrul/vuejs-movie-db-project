  ...
  <div class="container paddding">
      <div class="row mx-0">
          <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
              <div>
                  <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Diziler</div>
              </div>
              <div  v-for="movie in movies" class="row pb-4">
                  <div class="col-md-5">
                      <div class="fh5co_hover_news_img">
                          <router-link :to="{ name: 'diziSayfasi', params: { dizi_id: movie.scene_id, dizi_adi: seo(movie.scene_name)  }}">
                  ...
                  <div class="col-md-7 animate-box">
                      ...
                      <div class="fh5co_consectetur">
                        Dizi Açıklaması : {{movie.scene_description}}
                      </div>
                  </div>
              </div>
...
watch: {
  '$route.params.dizi_kategorisi': function (id) {
    this.$http
      .get("http://localhost:8888/api/api.php?getSeriesByCategory=" + this.$route.params.dizi_kategorisi)
      .then(function(data) {
        this.movies = data.body;
      });
    this.$http
      .get("http://localhost:8888/api/api.php?getSeriesTotalPageNumberByCategory=" + this.$route.params.dizi_kategorisi)
      .then(function(data) {
        console.log(data);
...
methods: {
  paging: function(page) {
    this.$http
      .get("http://localhost:8888/api/api.php?getSeriesByCategory="+ this.$route.params.dizi_kategorisi+"&pageNumber=" + page)
      .then(function(data) {
        this.movies = data.body;
      });
  },
