    ...
    <div class="container paddding">
        <div class="row mx-0">
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="http://via.placeholder.com/480x320" alt=""/></div>
                            <div></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img">
                                <img src="http://via.placeholder.com/480x320" alt=""/>
                            </div>
                            <div></div>
                        </div>
                    </div>
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Etiketler</div>
                </div>
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="http://via.placeholder.com/480x320" alt="img" class="fh5co_most_trading"/>
                    </div>
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center"><img src="http://via.placeholder.com/480x320" alt="img"
