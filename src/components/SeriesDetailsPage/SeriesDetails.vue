...
<div id="app">
  <div class="reviews-section">
                  ...
                  <p class="info"> <b>Sezon: </b> &nbsp; &nbsp;{{moviedata[0].scene_seasons}}</p>
...
export default {
  ...
  created() {
    this.$http
      .get("http://localhost:8888/api/api.php?getMovieDetailPage=" + this.$route.params.dizi_id )
      .then(function(data) {
          this.moviedata = data.body;
      });
    this.$http
      .get("http://localhost:8888/api/api.php?getMovieDetailPageCategories=" + this.$route.params.dizi_id )
      .then(function(data) {
          this.categories = data.body;
      });
    this.$http
      .get("http://localhost:8888/api/api.php?getMovieDetailPageStars=" + this.$route.params.dizi_id )
      .then(function(data) {
          this.stars = data.body;
      });
    this.$http
      .get("http://localhost:8888/api/api.php?getMovieDetailPageCompanies=" + this.$route.params.dizi_id )
      .then(function(data) {
          this.companies = data.body;
      });
    this.$http
      .get("http://localhost:8888/api/api.php?getMovieDetailPageDirectors=" + this.$route.params.dizi_id )
      .then(function(data) {
