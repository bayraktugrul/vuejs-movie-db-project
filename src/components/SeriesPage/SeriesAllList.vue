...
methods: {
  paging: function(page) {
    this.$http
      .get("http://localhost:8888/api/api.php?getSeries&pageNumber=" + page)
      .then(function(data) {
...
created() {
  this.$http
    .get("http://localhost:8888/api/api.php?getSeries")
    .then(function(data) {
      this.movies = data.body;
    });
  this.$http
    .get("http://localhost:8888/api/api.php?getSeriesTotalPageNumber")
    .then(function(data) {
      console.log(data);
